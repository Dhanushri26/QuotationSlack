...
const SideBar = () => {
  ...
  const menuItems = [
    {
      ...
      icon: (
        <DashboardIcon
          sx={{ color: "lightgrey", ml: "-2px", fontSize: "1.3rem" }}
        />
      ),
    },
    {
  ...
  const DrawerList = (
    ...
    >
      <Box
        sx={{ width: 250, mt: "5rem", backgroundColor: "transparent" }}
        role="presentation"
        ...
        <List>
          {menuItems.map((item, index) => (
            <ListItem key={index} disablePadding>
              ...
              >
                <ListItemIcon sx={{ ml: -2, pl: 1, color: "lightgrey" }}>
                  {item.icon}
                </ListItemIcon>
    ...
    <Box sx={{ display: "flex" }}>
      ...
      >
        <List>
          ...
          <Divider
            sx={{ backgroundColor: "lightgray", my: 1, width: "70%", ml: 1 }}
          />
          {menuItems.map((item, index) => (
            <ListItem
              key={index}
